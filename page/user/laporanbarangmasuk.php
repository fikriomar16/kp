<center>
	...
	<div class="card box" style="width: 600px;height: 220px;margin-top: 100px;">
		...
		<div class="card-body">
			<form method="POST" class="form-group" id="masuk" name="masuk" action="cetak/masuk.php" target="_blank">
				<div class="row">
					<div class="col-3">
				...
				<hr>
				<div class="form-group">
					<button class="btn btn-primary" type="submit" id="cmasuk" name="cmasuk">
